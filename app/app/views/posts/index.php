<div class="container-fluid px-0">
    <div class="container">
        ...
        <header id="post-header" class="d-flex-between">
            <h1 id="main-heading">Posts Content</h1>
            <label class="switch">
            ...
            <div class="col">
                    ...
                    <div class="post card mt-5 p-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mx-auto text-center">
                                <img style="width: 80%;" height="600" src="<?php echo $blog['image_src'] ?>">
                            </div>
                            <?php endif ?>
                            ...
                            <!-- POST LINK -->
                            <div>
                                <a class="btn btn-outline-primary" href="<?php echo $_ENV['APP_SRC'] . "post/show/" . $blog['post_id'] ?>">Read More</a>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center">There are no posts yet</h5>
                        <p class="card-text text-muted text-center">Be the first to create new post</p>
                        <hr>
        ...
        <script src="<?php echo js_url('js/posts/main') ?>"></script>
        <script src="<?php echo js_url('js/posts/selectBox') ?>"></script>
    </div>
</div>